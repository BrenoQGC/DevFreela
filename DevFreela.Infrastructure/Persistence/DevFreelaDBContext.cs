...
namespace DevFreela.Infrastructure.Persistence
{
    public class DevFreelaDbContext
    {
        public DevFreelaDbContext()
        {
            ...
            Users = new List<User>
            {
                new User("Luis Felipe", "luisdev@mail.com.br", new DateTime(1992, 1, 1)),
                new User("Robert C Martin", "robert@mail.com.br", new DateTime(1950, 1, 1)),
                new User("Anderson", "anderson@mail.com.br", new DateTime(1980, 1, 1)),
            };
